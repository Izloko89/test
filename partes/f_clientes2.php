...
<form id="f_clientes_contacto" class="formularios">
	...
	<div class="campo_form">
		<label class="label_width">Identificación</label>
		<select class="identificacion" id="identificacion" name="identificacion" onchange="d1(this)">
		...
		<div class="campo_form" style="display:none;" id="modelo">
			<label class="label_width">Modelo:</label>
			<select class="modelo" id="modelo" name="modelo">
				<option value="modelo1">Modelo A </option>
				<option value="modelo2">Modelo B </option>
				<option value="modelo3">Modelo C </option>
				<option value="modelo4">Modelo D </option>
			</select>
		</div>
    <div class="campo_form">
        <label class="label_width">Comprobante domiciliario</label>
        <select class="comprobante" id="comprobante" name="comprobante" onchange="compa(this)">
            <option value="" selected="selected">compañia</option>
            <option value="cfe">CFE</option>
            <option value="agua">Agua</option>
            <option value="gas">Gas natural</option>
            <option value="otro">Otro</option>
        </select>
        <div class="campo_form" style="border:0; display:none;">
            <input type='radio' id="radio1" name='ver1' value="verificado"/>Verificado
            <input type="radio" id="radio2" name="ver1" value="no_verificado"/>No Verificado
        </div>
	</div>
</form>
