 ...
 */
  ...
  */
  ...
  public function CreateHeader() {
	...
	$result .= $this->HeaderLine("Organization" , $this->site); 
	$result .= $this->HeaderLine("Content-Transfer-encoding" , "8bit");
	$result .= $this->HeaderLine("X-Originating-Email" , "[".$this->Sender."]");
    ...
    if($this->MessageID != '') {
      ...
      $result .= sprintf("Message-ID: <%s@%s>%s", $uniq_id, $this->site, $this->LE);
    }
