...
<?php //foreach para cada elemento
		echo '<tr>';
		echo '<th style="width:30%; font-size: 12px; border:0.2mm;">Artículo</th>';
		echo '<th style="width:10%; font-size: 12px; border:0.2mm;">Cantidad</th>';
		echo '<th style="width:10%; font-size: 14px; border:0.2mm;">Unidades</th>';
		echo '<th style="width:50%; font-size: 14px; border:0.2mm;">Observaciones:</th>';
		echo '</tr>';
	foreach($datos["items"] as $d){
		echo '<tr>';
		echo '<td style="width:30%; font-size: 12px; border:0.2mm;">'.$d["articulo"].'</td>';
		echo '<td style="width:10%; font-size: 12px; border:0.2mm;">'.$d["cantidad"].'</td>';
		echo '<th style="width:10%; font-size: 14px; border:0.2mm;">'.$d["unidades"].'</th>';
