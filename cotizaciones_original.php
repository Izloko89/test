...
<div id="tabs">
  ...
  <div id="hacer">
    ...
    <?php }else{ ?>
        <input type="hidden" name="id_cotizacion" id="id_cotizacion" class="id_cotizacion" value="" />
    <?php } ?>
    ...
    <h3 class='titulo_form'>Cuenta</h3>
        ...
        <div align="right">
        <form action="scripts/pdf.php" method="GET" target="_blank">
        <input type="hidden" name="id_coti" id="id_coti" class="id_cotizacion" value="">
        <input type="submit"  value="Imprimir cotizacion" onmouseover="toma_valor()">
        	...
        	function toma_valor()
        	{
        	var valor = document.getElementById("id_cotizacion").value;
        	
        	document.getElementById("id_coti").value = valor;
